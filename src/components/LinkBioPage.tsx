...
import { MessageCircle, MapPin, Monitor, Globe } from 'lucide-react'; // Importa o ícone Globe
...
const LinkBioPage: React.FC = () => {
    return (
        ...
        <div className="w-full max-w-md mx-auto rounded-xl shadow-lg pt-0 px-4 flex flex-col items-center container-card">
            ...
            {/* Adicionado inline-flex, items-center, justify-center e ícone Globe */}
            ...
            className="w-full text-center py-1.5 px-6 rounded-lg font-semibold text-lg mb-2 shadow-md 
                    ...
                    inline-flex items-center justify-center"> {/* Adicionado inline-flex, items-center, justify-center */}
                <Globe size={20} className="mr-2" /> {/* Ícone do Lucide React */}
                Visite Nosso Site
            </a>
